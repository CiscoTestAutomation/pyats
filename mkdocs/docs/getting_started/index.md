...
!!! tip "Cisco Internal Engineering"
...
[AEtest Package](../aetest/index.md).

Testscripts are [structured](../aetest/structure.md) Python files that
...
This example uses Python [argparse](https://docs.python.org/3/library/argparse.html) 
to parse command line arguments for atestbed file input, and passes it to the
script as the ``testbed`` [script parameter](../aetest/parameters.md). This is a
good practice to do - take arguments from command line makes your script more dynamic.
...
The `#!python if __name__ == '__main__'` block in your testscript will invoke AEtest
...
A [job](../easypy/jobfile.md) is a step above simply running testscripts as
an executable and getting output in STDOUT. Job files enables the execution of
testscripts as [tasks](../easypy/tasks.md) in standardized runtime environment,
...
`#!python if __name__ == '__main__'` block is ignored. Add the ``--html-logs`` argument
...
log files - eg, everything that was generated in your job's 
[runinfo folder](../easypy/runinfo.md).
...
- **Feature Usage**: [https://github.com/CiscoTestAutomation/examples](https://github.com/CiscoTestAutomation/examples)

- **Solutions and Scripts**: [https://github.com/CiscoTestAutomation/solutions_examples](https://github.com/CiscoTestAutomation/solutions_examples)
